...
function moveValuesOnly() {
  ...
  var destination_sheet = ss.getSheets()[0];
  var destination_range = destination_sheet.getDataRange();
  source.copyTo(destination_range, {contentsOnly: true});
}
...
function updateWeek()
{
 var ss = SpreadsheetApp.getActiveSpreadsheet();
  ...
  sheet = ss.getSheets()[10];
  sheet.getRange("D1").setValue(dateFrom_Short);
  sheet.getRange("E1").setValue(dateTo_Short);
  sheet = ss.getSheets()[9];
  sheet.getRange("T2").setValue(dateFrom_Short);
  sheet.getRange("U2").setValue(dateTo_Short); 
}

/* Force formula updates: Triggered different days of the week */
function updateGameOne() {
  var ss = SpreadsheetApp.getActiveSpreadsheet();
  var sheet;
   updateWeek();
  /* Refresh values */
  sheet = ss.getSheets()[2];/* Game 1 */
  sheet.getRange("E1").setValue("Last: " + new Date());
}
...
function updateGameTwo() {
  ...
  var sheet;
   updateWeek();
  /* Refresh values */
  sheet = ss.getSheets()[3]; /* Game 2 */
  sheet.getRange("E1").setValue("Last: " + new Date());
}

function updateGameThree() {
  var ss = SpreadsheetApp.getActiveSpreadsheet();
  var sheet;
   updateWeek();
  /* Refresh values */
  sheet = ss.getSheets()[4]; /* Game 3 */
  sheet.getRange("E1").setValue("Last: " + new Date());
}
...
function updateGameFour() {
  ...
  var sheet;
   updateWeek();
  /* Refresh values */
  sheet = ss.getSheets()[5]; /* Game 4 */
  sheet.getRange("E1").setValue("Last: " + new Date());
}

function updateGameFive() {
  var ss = SpreadsheetApp.getActiveSpreadsheet();
  var sheet;
   updateWeek();
  /* Refresh values */
  sheet = ss.getSheets()[6]; /* Game 5 */
  sheet.getRange("E1").setValue("Last: " + new Date());
}

function updateLastEightAvg() {
  var ss = SpreadsheetApp.getActiveSpreadsheet();
  var sheet;
   updateWeek();
  /* Refresh values */
  sheet = ss.getSheets()[7]; /* Last 8 */
  sheet.getRange("D1").setValue("Last: " + new Date());
}

function updateLastThreeAvg() {
  var ss = SpreadsheetApp.getActiveSpreadsheet();
  var sheet;
   updateWeek();
  /* Refresh values */
  sheet = ss.getSheets()[8]; /* Last 3 */
  sheet.getRange("D1").setValue("Last: " + new Date());
}
